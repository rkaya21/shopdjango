        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden sm:flex items-center gap-2">
            {user && (
              ...
              >
                <svg className="w-5 h-5 fill-transparent" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
              ...
              <div className="relative" ref={menuRef}>
                ...
                {menuOpen && (
                  <div className="absolute right-0 mt-2 w-52 bg-white rounded-2xl shadow-xl border border-surface-100 py-2 animate-fade-in-scale origin-top-right">
                    ...
                    >
                      <svg className="w-4 h-4 text-surface-400 fill-transparent" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                      </svg>
                      Favorilerim
                    </Link>
      ...
      {mobileOpen && (
        <div className="sm:hidden border-t border-surface-100 bg-white animate-fade-in">
          <div className="px-4 py-3 space-y-1">
            ...
            {user ? (
              <>
                <Link to="/wishlist" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-surface-700 hover:bg-surface-50">
                  <svg className="w-5 h-5 text-surface-400 fill-transparent" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                  </svg>
                  Favorilerim {wishlistCount > 0 && <span className="text-xs bg-brand-100 text-brand-700 px-2 py-0.5 rounded-full font-medium">{wishlistCount}</span>}
                </Link>
